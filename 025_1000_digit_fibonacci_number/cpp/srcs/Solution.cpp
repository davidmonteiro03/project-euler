...
/*   Updated: 2025/04/15 15:15:15 by dcaetano         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	long long int solution = 2;
	boost::multiprecision::cpp_int prevPrev = 1;
	boost::multiprecision::cpp_int prev = 1;
	boost::multiprecision::cpp_int curr = 1;
	while (true)
	{
		std::size_t len = curr.str().size();
